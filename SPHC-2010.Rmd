...
### 4. Self-Reported Health Outcomes
#### 4.1. Prepare dataset
```{r}
##### Mental Health #####
...
#### 5.1. Prepare dataset
##### 5.1.1. Prescribed Drug Register
```{r}
# prepare dataset
...
##### 5.2.2. Mental health outcomes
###### 5.2.2.1. Use of antidepressants and anxiolytics
```{r}
...
# plot
color_values <- c( "Heterosexual" = "#2166AC", 
                   "Homosexual" = "#00BFC4", 
                   "Bisexual" = "orange", 
                   "Stockholm County" = "red" )
...
# combine and prepare datasets
results_combined <- full_join( results_N06A, results_N05B, by = "sexual_identity_2010" )
str( results_combined )
...
ggplot( 
  ...
  scale_color_manual( values = c( "red", "#87CEEB", "orange" ),
                      breaks = c( "Heterosexual", "Homosexual", "Bisexual" ) ) +
  
  scale_fill_manual( values = c( "red", "#87CEEB", "orange" ) ) +
  ...
  facet_wrap( ~ drug_class, 
              ...
              labeller = labeller( drug_class = c( "N05B" = "Anxiolytics",
                                                   "N06A" = "Antidepressants" ) ) ) +
  ggh4x::facetted_pos_scales( y = list(
    drug_class == "N05B" ~ scale_y_continuous( limits = c( 0, 0.8 ), breaks = c( 0, 0.2, 0.4, 0.6, 0.8 ) ),
    drug_class == "N06A" ~ scale_y_continuous( limits = c( 0, 1.6 ), breaks = c( 0, 0.4, 0.8, 1.2, 1.6 ) )
    ) )
```

```{r}
##### among participants who have any prescription during 2005-2021 #####
# average no. of prescriptions
