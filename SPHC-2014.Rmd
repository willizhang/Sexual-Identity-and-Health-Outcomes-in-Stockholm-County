...
# self-rated health
table( d_2014_complete$U3G3, useNA = "always" )
d_2014_complete$poor_health <- factor( if_else( d_2014_complete$U3G3 >= 4, "Yes", "No" ),
                                       levels = c( "Yes", "No" ) )
table( d_2014_complete$poor_health, useNA = "always" )

# chronic health condition or disability
table( d_2014_complete$U4aG4a, useNA = "always" )
d_2014_complete$chronic_condition <- factor( if_else( d_2014_complete$U4aG4a == 2, "Yes", "No" ),
                                             levels = c( "Yes", "No" ) )
table( d_2014_complete$chronic_condition, useNA = "always" )
```
...
table( d_2014_complete$U33G38, useNA = "always" )
table( d_2014_complete$U31G36, useNA = "always" )
d_2014_complete$U33G38 <- ifelse( d_2014_complete$U31G36 == 1 & is.na( d_2014_complete$U33G38 ), 7, d_2014_complete$U33G38 )
d_2014_complete$frequent_HED <- factor( if_else( d_2014_complete$U33G38 <= 3, "Yes", "No" ),
                                        levels = c( "Yes", "No" ) )
table( d_2014_complete$frequent_HED, useNA = "always" )
