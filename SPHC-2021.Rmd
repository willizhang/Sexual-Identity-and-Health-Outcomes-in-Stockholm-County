---
title: "Sexual identity and health outcomes in Stockholm County, SPHC 2021"
author: Willi Zhang
...
# self-rated health
table( d_2021_complete$F1, useNA = "always" )
d_2021_complete$poor_health <- factor( if_else( d_2021_complete$F1 >= 4, "Yes", "No" ),
                                       levels = c( "Yes", "No" ) )
table( d_2021_complete$poor_health, useNA = "always" )

# chronic health condition or disability
table( d_2021_complete$F2A, useNA = "always" )
d_2021_complete$chronic_condition <- factor( if_else( d_2021_complete$F2A == 2, "Yes", "No" ),
                                             levels = c( "Yes", "No" ) )
table( d_2021_complete$chronic_condition, useNA = "always" )
```
...
table( d_2021_complete$F29_Q41, useNA = "always" )
table( d_2021_complete$F27_Q39, useNA = "always" )
d_2021_complete$F29_Q41 <- ifelse( d_2021_complete$F27_Q39 == 5 & is.na( d_2021_complete$F29_Q41 ), 5, d_2021_complete$F29_Q41 )
d_2021_complete$frequent_HED <- factor( if_else( d_2021_complete$F29_Q41 <= 2, "Yes", "No" ),
                                        levels = c( "Yes", "No" ) )
table( d_2021_complete$frequent_HED, useNA = "always" )
